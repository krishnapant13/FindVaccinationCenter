...
import com.example.findcovidvc.CenterRVAdapter
...
import com.example.findcovidvc.R
import com.example.findcovidvc.centerRvModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchButton.setOnClickListener {
            ...
            if (pinCode.length != 6) {
                ...
                Toast.makeText(this@MainActivity, "Enter Six Digit Of PinCode", Toast.LENGTH_SHORT).show()
            } else {
            ...
            JsonObjectRequest(Request.Method.GET, url, null, { response ->
                ...
                try {
                    ...
                    if (centerArray.length().equals(0)) {
                        Toast.makeText(this, "No Centers Available For Now", Toast.LENGTH_SHORT).show()
                    }
